...
<script>
    $(function () {
        $("#album-show-table").jqGrid({
            ...
            datatype: "json",
            height: 190,
            colNames: ['编号', '专辑名称', '专辑作者', '专辑封面', '音乐数量', '专辑内容', '创建时间'],
            colModel: [
                {name: 'id', hidden: true},
                {name: 'name', editable: true},
                {
                    ...
                    editable: true,
                    edittype: "select",
                    editoptions: {dataUrl: "${pageContext.request.contextPath}/star/selectAll"},
                ...
                },
                {
                    ...
                    edittype: "file",
                    formatter: function (value, option, rows) {
                        return "<img style='width:100px;height:60px;' src='${pageContext.request.contextPath}/album/img/" + rows.coverImg + "'>";
                    }
                },
                {name: 'count'},
                {name: 'content', editable: true},
                {name: 'pubDate', editable: true, edittype: "date"}
            ],
            styleUI: "Bootstrap",
            autowidth: true,
            rowNum: 3,
