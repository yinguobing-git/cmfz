...
<head>
    ...
    <script>
        ...
        $.extend($.validator.messages, {
            ...
            minlength: $.validator.format("<span style='color:red'>最少{4}个字符</span>"),
        });
        //表单提交
        $(function () {
                        ...
                        <form role="form" action="${pageContext.request.contextPath}/admin/login" method="get"
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="password" placeholder="请输入密码..."
                                       minlength="4" class="form-password form-control" id="form-password">
                            </div>
                            <div class="form-group">
                            ...
                            <a href="${pageContext.request.contextPath}/login/regist.jsp"><input type="button"
